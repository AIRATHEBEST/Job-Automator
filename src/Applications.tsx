    ...
    return (
      <div className="min-h-screen bg-neutral-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-neutral-400">Loading applications...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {applications.length === 0 ? (
          <div className="text-center py-12 bg-neutral-800 rounded-lg">
            ...
            <p className="text-neutral-400 mb-6">Start applying to jobs to see them here</p>
            <a
              href="/jobs"
          ...
          <div className="space-y-6">
            {applications.map((application) => (
              <div
                key={application.id}
                className="bg-neutral-800 rounded-lg p-6 border border-neutral-700 hover:border-purple-500/50 transition-all"
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-neutral-300 mb-2">{application.company}</p>
                  </div>
                ...
                {application.cover_letter && (
                  <div className="mb-4">
                    <h4 className="text-sm font-medium text-neutral-300 mb-2">Cover Letter</h4>
                    <p className="text-neutral-400 text-sm bg-neutral-900 p-4 rounded-lg">
                      {application.cover_letter}
                    </p>
                  </div>
                )}
